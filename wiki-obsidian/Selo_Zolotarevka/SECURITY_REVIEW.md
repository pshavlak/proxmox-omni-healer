...
---
**Связанные страницы:** [[VULNERABILITY_LIST|Список уязвимостей]], [[FINAL_RISK_SIGNOFF|Риск-сигнофф]], [[REMEDIATION_PLAN|План исправлений]], [[BACKEND_PLAN|План бэкенда]], [[HANDOFF_FRONTEND_SECURITY|Передача фронтенд+security]]
